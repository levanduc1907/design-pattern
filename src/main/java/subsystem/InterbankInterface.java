...
public interface InterbankInterface {
	 ...
	 * 
	 * @param paymentType     - the type used for payment
	 ...
	 */
	public abstract PaymentTransaction payOrder(PaymentType paymentType, int amount, String contents)
			throws PaymentException, UnrecognizedException;

	/**
	 * Refund, and then return the payment transaction
	 * 
	 * @param paymentType     - the payment type which would be refunded to
	 ...
	 *                               something goes wrong
	 */
	public abstract PaymentTransaction refund(PaymentType paymentType, int amount, String contents)
			throws PaymentException, UnrecognizedException;
